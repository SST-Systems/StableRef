...
Записи, чей ID не резолвится, **Fix All пропускает и сохраняет** (восстанови тип или его `[StableTypeId]` и запусти снова); удалить такую осознанно — правый клик → **Clear Entry**.
