...
namespace SST.StableRef
{
    public static class StableRefTypeRegistry
    {
        ...
        private static void Register(string id, Type type)
        {
            ...
            // The attribute id is canonical: resolving legacy data through an old MonoScript GUID must
            // not make GetOrAssignId stamp that GUID onto a type that carries [StableTypeId] — the
            // documented GUID→attribute migration relies on the attribute winning. Both ids resolve.
